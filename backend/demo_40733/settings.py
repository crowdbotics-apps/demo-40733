"""
Django settings for demo_40733 project.
...
WSGI_APPLICATION = 'demo_40733.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_40733 API",
    "DESCRIPTION": "API documentation for demo_40733 App",
    "VERSION": "v1",
}
